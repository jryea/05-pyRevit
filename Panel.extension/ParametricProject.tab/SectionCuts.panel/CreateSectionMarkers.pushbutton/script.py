...
print('number of drafting views: ')
print(len(drafting_views))
print('number of drafting views on sheet: ')
print(len(drafting_views_on_sheet))
...
print(detail_01_ref_view)
print(detail_02_ref_view)
...
with revit.Transaction('Create Section Cuts'):
  ...
  print('length of column joist intersections: ')
  print(len(detail_02_location_pts_w_direction))
